...
export default {
  ...
  methods: {
    ...
    download() {
      console.log("download compressedPath: ", this.instance.compressedPath);
      console.log("download path: ", this.instance.path);
      this.loading = false;
      readFile(this.instance.path).then(
        data => {
          const file = new Blob([data], { type: "image/jpeg" });
          ...
          if (this.instance.compressedPath) {
            ...
            console.log("read file compressedPath");
